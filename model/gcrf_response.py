...
X_train, Y_train, X_test, Y_test = getData(filename, x_length, y_length,percentage, args.input_dim,args.inputCols,typeModel=1) #gs.getSamples(filename, x_length, y_length)
